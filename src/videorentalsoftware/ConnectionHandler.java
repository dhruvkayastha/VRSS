...
public class ConnectionHandler {
	...
	static final String DB_URL = "jdbc:mysql://localhost:3306/VrsDatabase?user=root" +
	...
	public static Connection createConnection() throws InstantiationException, IllegalAccessException{
		...
		try {
			...
			Class.forName(JDBC_DRIVER).newInstance();
                        ...
                        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/VrsDatabase?user=root"
                        + "&password=password");
			System.out.println("Connecting to" + DB_URL);
