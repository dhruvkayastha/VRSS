 ...
 * @author dhruv
 */
public class CustomerDatabaseForm extends javax.swing.JFrame {

    /**
     * Creates new form CustomerDatabaseForm
     */
    public CustomerDatabaseForm() {
        ...
        try {
            ...
            String sql = "select `id`, `name`, `username`, `phoneNo`, `sex`, `musicRentals`, `videoRentals` from Customer";
    ...
    private void initComponents() {
        ...
        setTitle("VRS Customer Database");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Name", "Username", "Video Rentals", "Music Rentals", "Phone No", "Sex"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerDatabaseForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(CustomerDatabaseForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(CustomerDatabaseForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
